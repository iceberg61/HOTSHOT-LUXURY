          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <input
                ...
                className="w-full bg-zinc-900 border border-zinc-800 text-white text-xs px-4 py-4 tracking-wider placeholder-zinc-600 focus:outline-none focus:border-red-500 transition-colors"
              />
              <input
                type="text"
            ...
            <textarea
              ...
              rows={7}
              className="w-full bg-zinc-900 border border-zinc-800 text-white text-xs px-4 py-4 tracking-wider placeholder-zinc-600 focus:outline-none focus:border-red-500 transition-colors resize-none"
            />

            {/* Submit */}
            <button className="w-full sm:w-auto bg-red-500 text-white text-xs tracking-[0.3em] uppercase px-12 py-4 hover:bg-red-600 transition-all duration-300">
              SUBMIT NOW
            </button>
